            ...
            if (txtUsuario.Text != String.Empty)
            {
                if (txtLogin.Text != String.Empty)
                {
                    ...
                    {   
                        ...
                        VariablesGlobales.Id_Perfil = (int)row["Id_Perfil"];           
                        VariablesGlobales.DescPerfil = row["DescPerfil"].ToString();   
                        VariablesGlobales.CatPerfil = (int)row["CatPerfil"];           
                        #endregion

                        Response.Redirect("~/Páginas/FrmMonitoreoReservas.aspx");
                    }
                }
                else
                {
