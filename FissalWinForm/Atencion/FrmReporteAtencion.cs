...
namespace FissalWinForm
{
    public partial class FrmReporteAtencion : Form
    {
        ...
        MovimientoPaciente objEstablecimiento = new MovimientoPaciente();
        MovimientoPacienteBL objEstablecimientoBL = new MovimientoPacienteBL();
        ...
        public void MovimientoPaciente_Filtrar()
        {
            try
            {
                ...
                if (opc01.Checked == true)
                {
                    ...
                    dt = objEstablecimientoBL.MovimientoPaciente_Filtrar(1, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text), VariablesGlobales.EstablecimientoId);
                ...
                else
                {
                    ...
                    {
                        if (ValidarRangoFechas() == true) return;
                        dt = objEstablecimientoBL.MovimientoPaciente_Filtrar(2, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text), VariablesGlobales.EstablecimientoId);
                        dgvAtencion.DataSource = dt;
                        dgvAtencion.Focus();
                    }
                    else
                    {
                        ...
                        {
                            if (ValidarRangoFechas() == true) return;
                            dt = objEstablecimientoBL.MovimientoPaciente_Filtrar(3, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text), VariablesGlobales.EstablecimientoId);
                            dgvAtencion.DataSource = dt;
                            dgvAtencion.Focus();
                        }
                        else
                        {
                            ...
                            {
                                if (ValidarRangoFechas() == true) return;
                                dt = objEstablecimientoBL.MovimientoPaciente_Filtrar(4, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text), VariablesGlobales.EstablecimientoId);
                                dgvAtencion.DataSource = dt;
                                dgvAtencion.Focus();
                            }
                            else
                            {
                                ...
                                {
                                    if (ValidarRangoFechas() == true) return;
                                    dt = objEstablecimientoBL.MovimientoPaciente_Filtrar(5, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text), VariablesGlobales.EstablecimientoId);
                                    dgvAtencion.DataSource = dt;
                                    dgvAtencion.Focus();
                                }
                            }
        ...
        public void MovimientoPaciente_FiltrarxAdministrador()
        {
            try
            {
                ...
                {
                    if (ValidarRangoFechas() == true) return;
                    dt = objEstablecimientoBL.MovimientoPaciente_FiltrarxAdministrador(1, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text));
                    dgvAtencion.DataSource = dt;
                    dgvAtencion.Focus();
                }
                else
                {
                    ...
                    {
                        if (ValidarRangoFechas() == true) return;
                        dt = objEstablecimientoBL.MovimientoPaciente_FiltrarxAdministrador(2, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text));
                        dgvAtencion.DataSource = dt;
                        dgvAtencion.Focus();
                    }
                    else
                    {
                        ...
                        {
                            if (ValidarRangoFechas() == true) return;
                            dt = objEstablecimientoBL.MovimientoPaciente_FiltrarxAdministrador(3, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text));
                            dgvAtencion.DataSource = dt;
                            dgvAtencion.Focus();
                        }
                        else
                        {
                            ...
                            {
                                if (ValidarRangoFechas() == true) return;
                                dt = objEstablecimientoBL.MovimientoPaciente_FiltrarxAdministrador(4, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text));
                                dgvAtencion.DataSource = dt;
                                dgvAtencion.Focus();
                            }
                            else
                            {
                                ...
                                {
                                    if (ValidarRangoFechas() == true) return;
                                    dt = objEstablecimientoBL.MovimientoPaciente_FiltrarxAdministrador(5, txtNumLote.Text, txtNumCorrelativo.Text, TipoDocumentoId, txtDNI.Text, txtPaciente.Text, DateTime.Parse(dtpFechaInicio.Text), DateTime.Parse(dtpFechaFin.Text));
                                    dgvAtencion.DataSource = dt;
                                    dgvAtencion.Focus();
                                }
                            }
